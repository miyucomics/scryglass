...
import hexdoc_scryglass

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class ScryglassPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return ScryglassModPlugin(branch=branch)


class ScryglassModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "scryglass"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_scryglass, "_templates"
